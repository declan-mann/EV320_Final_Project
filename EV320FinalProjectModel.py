...
"""
"""
This information can also be found in the README file on GitHub
--------------------
...
# but we will reshape it into the 2D coordinate form - recognizing that we want it to follow the shape of X.
...
for i in range(nx):
    for k in range(ny):
        ...
        if i == 0: 
            ...
            A[ik, i * ny + k + 1]= sy
            A[ik, i * ny + k - 1]= sy
# You can print(A) if you believe the matrix is not correct
...
## Create a Difference Plot, to emphasize changes in elevation over the run time
